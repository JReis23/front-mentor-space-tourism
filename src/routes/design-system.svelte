			...
			<div class="flow" style="flex-basis: 100%; --flow-space: 4rem;">
				...
				<div>
					...
					<p>
						...
						nisi. Sed pretium, ligula sollicitudin laoreet viverra, tortor componentsero sodales
	...
	<section class="flow" id="interactive-elements">
		...
		<div class="flex">
			<div style="padding-top: 3rem;">
				<!-- explore button -->
				<Button type="large-button uppercase ff-serif fs-600 text-dark bg-white">Explore</Button>
			</div>
